...
class User extends Authenticatable
{
    ...
    public function getFuncao() {
        if($this->admin == 1 && $this->client == 0 && $this->superadmin == 0){
            ...
            return 'Cliente';
        }elseif($this->admin == 0 && $this->editor == 0 && $this->colaborador == 1 && $this->superadmin == 0){
            return 'Colaborador';
    ...
    public function setColaboradorAttribute($value)
    {
        $this->attributes['colaborador'] = ($value === true || $value === 'on' ? 1 : 0);
    }
