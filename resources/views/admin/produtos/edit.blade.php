    ...
    <div class="tab-pane fade show active" id="custom-tabs-four-home" role="tabpanel" aria-labelledby="custom-tabs-four-home-tab">
        ...
        <div class="row mb-2">            
            ...
            <div class="col-12 col-sm-6 col-md-3 col-lg-3">
                <div class="form-group">
                    ...
                    <select name="exibivalores" class="form-control">
                        <option value="1" {{ (old('exibivalores') == '1' ? 'selected' : ($produto->exibivalores == '1' ? 'selected' : '')) }}>Sim</option>
                        <option value="0" {{ (old('exibivalores') == '0' ? 'selected' : ($produto->exibivalores == '0' ? 'selected' : '')) }}>Não</option>
                    </select>
                </div>
            </div>                          
            <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control mask-money" name="valor" value="{{ old('valor') ?? $produto->valor }}">
                </div>
            </div>                          
            <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Valor à Vista</b></label>
                    <input type="text" class="form-control mask-money" name="valor_vista" value="{{ old('valor_vista') ?? $produto->valor_vista }}">
                </div>
            </div>                          
            <div class="col-12 col-sm-6 col-md-3 col-lg-2">
                <div class="form-group">
                    <label class="labelforms text-muted"><b>Valor Promocional</b></label>
                    <input type="text" class="form-control mask-money" name="valor_promocional" value="{{ old('valor_promocional') ?? $produto->valor_promocional }}">
                </div>
            </div>
        </div>       
        ...
        <div class="row mb-2">
            <div class="col-12">   
                ...
                <x-adminlte-text-editor name="notas" v placeholder="Notas Técnicas..." :config="$config">{{ old('notas') ?? $produto->notas }}</x-adminlte-text-editor>                                                      
            </div>                                
        </div>                
    </div>                                   
