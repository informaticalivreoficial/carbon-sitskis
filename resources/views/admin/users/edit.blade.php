                                        ...
                                        <div class="col-sm-12 bg-gray-light mb-3">                                        
                                            ...
                                            <div class="form-group p-3 mb-0">
                                                ...
                                                <div class="form-check d-inline mx-2">
                                                    <input id="colaborador" class="form-check-input" type="checkbox" name="colaborador" {{ (old('colaborador') == 'on' || old('colaborador') == true ? 'checked' : ($user->colaborador == true ? 'checked' : '')) }}>
                                                    <label for="colaborador" class="form-check-label">Colaborador</label>
                                                </div> 
                                                <div class="form-check d-inline mx-2">
