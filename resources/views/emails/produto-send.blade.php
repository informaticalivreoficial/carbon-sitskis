...
{{-- Body --}}
    <div style="width:100%; padding:10px;">        
        ...
        <div style="background:#FFF; font:16px Trebuchet MS, Arial, Helvetica, sans-serif; color:#333; line-height:150%;">       
            <h1 style="font-size:20px; color:#000; background:#F4F4F4; padding:10px;">Dados da Consulta</h1>
            ...
            <br />
            <strong>Produto: </strong><strong style="color:#09F;"><a href="{{ route('web.produto', $produto_link) }}">{{$produto_nome}}</a></strong>
            <br />
